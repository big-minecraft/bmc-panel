                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <button type="button" className="btn-close" onClick={() => setCodeToRevoke(null)}></button>
                            </div>
                            <div className="modal-body">
                                Are you sure you want to revoke the invite code "{codeToRevoke}"?
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" onClick={() => setCodeToRevoke(null)}>Cancel</button>
